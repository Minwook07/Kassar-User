  ...
  <div class="container py-5">
    <div class="row g-4">
      ...
      <div class="col-12 col-md-3">
        <!-- Full width on small devices, 3 columns on medium and up -->
        <!-- Profile Card -->
        <div class="profile-card">
          <div class="profile-img-container">
            <img
              src="@/assets/images/user_pf_sample.jpg"
              alt="Profile Image"
          ...
          <div class="profile-info text-center">
            ...
            <div class="profile-social">
              <a
                href="https://www.facebook.com/profile.php?id=100036610731530&mibextid=LQQJ4d"
                class="social-link"
                ><i class="bi bi-facebook"></i
              ></a>
              <a href="#" class="social-link"><i class="bi bi-tiktok"></i></a>
              <a
                href="https://www.instagram.com/thyyyyy_o?igsh=ZWVmMzIwd2R4Nmw3&utm_source=qr"
                class="social-link"
                ><i class="bi bi-instagram"></i
              ></a>
              <a href="https://t.me/Chanthy_Sreoun7" class="social-link"
        ...
        <div class="tab-content">
          ...
          <div id="profile" class="tab-pane fade show active">
            ...
            <form class="profile-form p-4 bg-white rounded-4">
              ...
              <button
                class="btn btn-edit btn-primary py-2 rounded-pill shadow-sm"
              >
              ...
              <div class="bg-red">
                <div class="d-flex align-items-center gap-2 mt-4">
                  <svg
                    ...
                    height="24"
                    fill="currentColor"
                    class="warning-icon bi bi-exclamation-triangle-fill"
                    viewBox="0 0 16 16"
                  >
                    <path
