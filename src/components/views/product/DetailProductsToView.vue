			...
			<div v-if="detailProducts" class="row g-4">
					...
					<div class="product-gallery">
						...
						<div class="main-image-container mb-3">
							<div class="main-image-wrapper">
								<img :src="selectedImageUrl || detailProducts.product.product_thumbnail"
									alt="Product Image" class="main-product-image" />
						...
						<div class="thumbnail-gallery">
							<div class="thumbnail-scroll">
								<div v-for="(product_img, index) in [detailProducts.product.product_thumbnail, ...detailProducts.product.product_images]"
					...
					<div class="product-info">
						...
						<div class="product-header mb-4">
							<div class="category-badge mb-3">
								<span
									class="badge bg-primary/10 text-primary border border-primary rounded-pill px-3 py-2 fw-medium">
									<i class="bi bi-tag me-1"></i>{{ t('categories.' +
										(detailProducts.product?.category?.name)) }}
								</span>
							</div>
							...
							<div
								class="rating-section d-flex align-items-center gap-3 mb-4 pb-3 border-bottom border-border">
						...
						<div class="price-section mb-4 p-4 bg-card rounded-4 shadow-sm border border-border">
							<div v-if="detailProducts.product?.price && detailProducts.product.price.has_discount !== false"
								...
								<div class="discount-info">
									<span
										class="badge bg-destructive text-destructive-foreground rounded-pill px-3 py-2">
							...
							<div class="quantity-section mb-4">
								...
								<div class="quantity-controls d-flex align-items-center gap-3">
									<button
										...
										style="width: 45px; height: 45px;" @click="count > 0 && count--"
										:disabled="count <= 0">
								...
								<small class="text-muted-foreground mt-2 d-block">មានស្តុក {{
									detailProducts.product?.qty_in_stock || 0
						...
						<div class="payment-section p-4 bg-card rounded-4 shadow-sm border border-border">
							...
							<div class="payment-methods d-flex gap-2 flex-wrap">
								<div class="payment-method bg-muted rounded-3 p-2 border border-border">
									<img src="@/assets/images/cart-img/icon/visa.svg" alt="Visa"
										style="height: 24px;" />
								</div>
								<div class="payment-method bg-muted rounded-3 p-2 border border-border">
									<img src="@/assets/images/cart-img/icon/mastercard (1).svg" alt="Mastercard"
										style="height: 24px;" />
								</div>
								<div class="payment-method bg-muted rounded-3 p-2 border border-border">
									<img src="@/assets/images/cart-img/icon/unionpay.svg" alt="UnionPay"
										style="height: 24px;" />
								</div>
								<div class="payment-method bg-muted rounded-3 p-2 border border-border">
				...
				<div class="col-12 col-lg-8">
					<div class="product-tabs-section">
						<ul class="nav nav-pills nav-fill mb-4" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<button class="nav-link rounded-pill px-4 py-3 fw-semibold"
									:class="{ active: activeTab === 'reviews' }" @click="activeTab = 'reviews'">
									...
									<div class="review-item bg-white p-4 rounded-3 shadow-sm">
										<div class="d-flex gap-3">
											<div class="reviewer-avatar">
												<img src="@/assets/images/1.jpg" alt="Reviewer" class="rounded-circle"
													width="60" height="60" />
											</div>
				...
				<div class="col-12 col-lg-4">
					<div class="ad-section">
						<img src="@/assets/images/posterDetail.gif" alt="Advertisement"
