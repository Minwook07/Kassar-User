				...
				<template v-if="!showQR">
					<section>
						...
						<div class="p-3 d-flex flex-column">
							<button @click="handleCreditCardPayment" class="btn btn-primary mb-3 py-3">បង់ប្រាក់តាម​
								Credit Card</button>
					...
					<div class="aba-qr-modal">
						<div class="aba-qr-header">
							<div class="aba-logo-container">
								<img src="/logo-ABA.png" alt="ABA Logo" class="aba-logo" />
								<span class="aba-pay-text">ABA PAY</span>
							</div>
							<div class="timer-container">
								<span class="timer">{{ countdown }}:{{ timerSeconds < 10 ? '0' + timerSeconds :
										timerSeconds }}</span>
						...
						<div class="qr-container">
							...
							<img :src="`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=ABA_PAY_${totalAmount}`"
								alt="ABA QR Code" class="qr-code" />
						</div>
					</div>
				</template>
			</div>
