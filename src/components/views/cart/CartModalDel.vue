        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="py-4 modal-content d-flex justify-content-between align-items-center">
                <div class="text-center">
                    <span class="fw-bold fs-5" id="exampleModalLabel">លុបសំណួរ</span>
                    <p>សូមអាន និងឆ្លើយតបសារបញ្ជាក់</p>
                </div>
                <div class="w-75 mt-3">
                    <div class="text-center">
                        <i class="bi bi-arrow-right-circle"></i> 
                        <!-- តើអ្នកប្រាកដក្នុងការលុបសំណួរនេះឬ ? -->
                        តើអ្នកប្រាកដក្នុងការលុបអតិថិជន
                        <!-- <span class="fw-bolder"> {{ cartStore.product.name }}</span>? -->
...
// const onDeleteCart = () => {
//     axios.delete(`/api/carts/${cartStore.selected_id}`)
//         .then((res) => {
