<template>
    <div class="comments-container">
          ...
          <div v-for="(comment, index) in comments" :key="index" class="comment">
            ...
            <div class="comment-content">
              <div class="comment-header">
                ...
                <span class="comment-text" v-html="formatComment(comment.text)"></span>
              </div>
      ...
      <div class="comment-input-container">
        ...
        <button 
          class="post-btn" 
          :class="{ 'active': newComment.length > 0 }"
  ...
  const comments = reactive([
    {
      ...
      text: 'YES! YES! I\'M CAMBODIA! <span class="emoji">😈</span>',
      timestamp: '3d ago',
      likes: 323,
      isLiked: false,
    ...
    {
      username: 'Ah Dam <span class="emoji">💜</span> <span class="emoji">💖</span>',
      text: 'មានម្ដេចហើយ. ?',
      timestamp: '3d ago',
      likes: 2507,
      isLiked: false,
    ...
    {
      username: 'GODZILLA',
      text: 'what will happened it Myanmar empire return toungoo empire Bagan empire union Myanmar',
      timestamp: '3d ago',
      likes: 2,
      isLiked: false,
      avatar: '/placeholder.svg?height=40&width=40'
